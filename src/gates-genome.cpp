...
namespace representation {
	...
	unsigned gates::mutate(unsigned center, unsigned sigma, unsigned l_back) {
		return this->chromosome->mutate(center, sigma, SAFE_TYPE_ID(AND_GATE_ID), SAFE_TYPE_ID(XNOR_GATE_ID), l_back);
	}
